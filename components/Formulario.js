        ...
        <div className="w-full mt-20">
            ...
            <div className="mt-4">
                ...
                </div>
                {
                    tienePassword ? (<input
                        type="password"
                        className="appearance-none w-full mt-2 bg-white border border-gray-400 text-black py-3 px-4 rounded -leading-none focus:outline-none focus:border-gray-500pr-8"
